...
export function parseCsvFile(filePath, fileName) {
...
export function parseWorkbook(filePath, fileName) {
    ...
    for (const sheetName of sheetNames) {
        ...
        const rows = XLSX.utils.sheet_to_json(worksheet, { header: 1, raw: false, blankrows: false, defval: '' });
